            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Web-разработчик. Опыт с 2016 года. В основном занимаюсь фронтендом. Создаю красоту. Бэкенд также входит в мои интересы. </p>
                    </div>
                    <!-- section title -->
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-50">
                        ...
                        <p>Верстаю валидные шаблоны/письма по psd/figma макету, по картинкам, тексту, голосовым сообщениям. <br>
                            ...
                            Работаю с WordPress (доработывал плагины, натяжка шаблона), Yii2, Js, jquery, Bootstrap, СCS/SCSS, gulp.<br>
